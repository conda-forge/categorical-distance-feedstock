...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/categorical-distance-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14467&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/categorical-distance-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `categorical-distance` can be installed with:

```
conda install categorical-distance
```

It is possible to list all of the versions of `categorical-distance` available on your platform with:
